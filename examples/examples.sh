# 5sec, sd, 1 gpu
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 1 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_sd.yaml --output_filename ./test-1.mp4

# 5sec, sd, 2 gpus
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 2 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_sd.yaml --output_filename ./test-2.mp4

# 5sec, sd, 4 gpus
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 4 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_sd.yaml --output_filename ./test-4.mp4

# 5sec, sd, 8 gpus
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 8 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_sd.yaml --output_filename ./test-8-sd.mp4

# 5sec, sd, 1 gpu, magcache
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 1 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_sd.yaml --output_filename ./test-1-magcache.mp4 --magcache

# 5sec, hd, 1 gpu
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 1 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_hd.yaml --output_filename ./test-1-hd.mp4 --width 1280 --height 768

# 5sec, hd, 2 gpus
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 2 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_hd.yaml --output_filename ./test-2-hd.mp4 --width 1280 --height 768

# 5sec, hd, 4 gpus
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 4 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_hd.yaml --output_filename ./test-4-hd.mp4 --width 1280 --height 768

# 5sec, hd, 8 gpus
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 8 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_hd.yaml--output_filename ./test-8-hd.mp4 --width 1280 --height 768

# 5sec, hd, 1 gpu, magcache
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 1 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_i2v_5s_sft_hd.yaml --output_filename ./test-1-hd-magcache.mp4 --width 1280 --height 768 --magcache

# 10sec, sd, 1 gpu
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 1 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_t2v_10s_sft_sd.yaml --output_filename ./test-1-10sec.mp4 --video_duration 10
...
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 1 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_t2v_10s_sft_sd.yaml --output_filename ./test-1-10sec-magcache.mp4 --video_duration 10 --magcache

# 10sec, hd, 1 gpu
python -m torch.distributed.launch --nnodes 1 --nproc-per-node 1 test.py --prompt "A dog in red hat" --config ./configs/k5_pro_t2v_10s_sft_hd.yaml --output_filename ./test-1-10sec-hd.mp4 --video_duration 10 --width 1280 --height 768
